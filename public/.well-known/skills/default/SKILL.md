...
- **configure:** open http://localhost:5015 after setup; the first-run wizard handles password and identity, then asks how sol should think: local on this machine (the default when the hardware can), your own AI engine, or confidential processing (coming, scouts first)
