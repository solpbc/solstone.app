-- migration 0018_service_handoffs_spb
-- Broaden service_handoffs.service from CHECK (service IN ('scout','push','spl'))
-- to CHECK (service IN ('scout','push','spl','spb')) for SPB /enable/spb + /handoff/spb.
--
...
-- 3. If service_handoffs already has CHECK (service IN ('scout','push','spl','spb')), rerunning
