-- migration 0022_spp_service_handoffs
-- Broaden service_handoffs.service from CHECK (service IN ('scout','push','spl','spb'))
-- to CHECK (service IN ('scout','push','spl','spb','spp')) for SPP service handoffs.
--
...
-- 3. If service_handoffs already has CHECK (service IN ('scout','push','spl','spb','spp')), rerunning
