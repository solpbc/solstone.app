-- migration 0010_service_handoffs_push
-- Broaden service_handoffs.service from CHECK (service IN ('scout'))
-- to CHECK (service IN ('scout','push')) for L9W /enable/push + /handoff/push.
--
...
-- 3. If service_handoffs already has CHECK (service IN ('scout','push')), rerunning
