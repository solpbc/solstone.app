...
.sunarc-twilight, .sunarc-glow, .sunarc-sun { position: absolute; pointer-events: none; }
...
/* The conventional app shell for a single-column portal: brand-home on the
   ...
   owner's sign-in to manage their services (services brand canon § "the
   account relationship — internal only"; operator direction 2026-06-11). */
.topbar {
...
.pricecard .big { font-family:var(--font-display); font-weight:700; font-size:1.5rem; color:var(--ink); }
