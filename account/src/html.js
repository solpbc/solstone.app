...
<ul>
  ...
  <li><strong>${esc(`you keep what you paid for.`)}</strong>${esc(` when you cancel, the service keeps working until the end of the period you've already paid for, then stops. we don't prorate a cancellation you make on your own, and we don't claw back; sections 5, 7, and 9 name the times we do refund unused time, and section 14 names one more. for confidential processing, what a plan includes within a period is part of the plan terms shown at checkout (section 13).`)}</li>
