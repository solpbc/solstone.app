...
export function makeTestEnv(overrides = {}) {
  ...
  return {
    ...
    IMPERSONATE_DISABLED: overrides.IMPERSONATE_DISABLED,
    ...
    WITHDRAWAL_DOOR: overrides.WITHDRAWAL_DOOR,
    ...
    ACCOUNT_RELAY_PURGE_BEARER_TOKEN: overrides.ACCOUNT_RELAY_PURGE_BEARER_TOKEN || 'test-relay-purge-bearer',
    ACCOUNT_SUPPORT_PURGE_BEARER_TOKEN: overrides.ACCOUNT_SUPPORT_PURGE_BEARER_TOKEN || 'test-support-purge-bearer',
    ACCOUNT_RELAY_PURGE_HMAC_KEY_V1: overrides.ACCOUNT_RELAY_PURGE_HMAC_KEY_V1 || 'owner-purge-v1-fixture-test-key',
    ACCOUNT_RELAY_PURGE_HMAC_KEY_V2: overrides.ACCOUNT_RELAY_PURGE_HMAC_KEY_V2 || 'owner-purge-v2-fixture-test-key',
    ACCOUNT_SUPPORT_PURGE_HMAC_KEY_V1: overrides.ACCOUNT_SUPPORT_PURGE_HMAC_KEY_V1 || 'owner-purge-v1-fixture-test-key',
    ACCOUNT_SUPPORT_PURGE_HMAC_KEY_V2: overrides.ACCOUNT_SUPPORT_PURGE_HMAC_KEY_V2 || 'owner-purge-v2-fixture-test-key',
    HUB_WEBHOOK_URL: overrides.HUB_WEBHOOK_URL,
    HUB_SUBSCRIPTION_CREATED_URL: overrides.HUB_SUBSCRIPTION_CREATED_URL,
...
function makeDefaultPurgeBinding(service, overrides = {}) {
  return {
...
export async function seedEntitlement({
  ...
  await env.DB
    ...
    .bind(accountId, service, status, currentPeriodEnd, source, sourceRef, Number(cancelAtPeriodEnd), enabledAt, updatedAt)
    .run();
  return { accountId, service, status, currentPeriodEnd, source, sourceRef, cancelAtPeriodEnd, enabledAt, updatedAt };
}
