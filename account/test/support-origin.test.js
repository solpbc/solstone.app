...
function supportPostRoutes() {
  return [
    { name: 'create', path: '/support', fields: { product: 'solstone', subject: 'help me', description: 'details here', attachment_operation_key: KEY_B, safe_content: 'confirmed' } },
    { name: 'reply', path: '/support/REQ_1/reply', invalidPath: '/support/bad.id/reply', fields: { content: 'reply body', attachment_operation_key: KEY_B, safe_content: 'confirmed' } },
    { name: 'attachments', path: '/support/REQ_1/attachments', invalidPath: '/support/bad.id/attachments', fields: { safe_content: 'confirmed' }, file: new File(['bytes'], 'proof.log', { type: 'text/plain' }) },
